function [ListAlgoName,ListColor,ListMarker,ListShortName] = GetFormatFightClub
%% function [ListAlgoName,ListColor,ListMarker,ListShortName] = GetFormatFightClub
%
% Created by Arthur Chavignon for ULM PARLA 20/03/2020

ListAlgoName = {'No Shift','WA','Cub-Interp','Lz-Interp','Sp-Inter','Gauss-Fit','RS'};
